...
export function SatelliteCard({ satellite, onClose }: SatelliteCardProps) {
  const typeLabels = {
  ...
  return (
    <div className="absolute bottom-24 sm:bottom-28 md:bottom-32 left-1/2 -translate-x-1/2 w-[calc(100%-32px)] sm:w-[400px] md:w-[440px] max-w-[440px] liquid-glass-intense rounded-2xl sm:rounded-3xl overflow-hidden animate-slide-up z-30">
      <div className="absolute inset-0 bg-gradient-to-b from-white/[0.05] to-transparent pointer-events-none" />
      
      <div className={cn("h-1 sm:h-1.5 bg-gradient-to-r", typeGradients[satellite.type])} style={{ boxShadow: `0 0 20px ${rgbColor}` }} />
