...
import { Search, Satellite, Trash2, Building, Radio, AlertTriangle, Rocket, MapPin, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className={cn(
        ...
        <div className="relative p-5 sm:p-6 lg:p-7 border-b border-white/[0.06]">
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="relative">
              <div className="w-11 h-11 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-xl sm:rounded-2xl liquid-glass-intense flex items-center justify-center liquid-glow-cyan animate-float">
                <Satellite className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-cyan-400" />
              </div>
              <div className="absolute -bottom-0.5 -right-0.5 sm:-bottom-1 sm:-right-1 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-green-400 rounded-full border-2 border-black/50 animate-pulse" />
            </div>
            <div>
              <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-gradient-cyan tracking-tight">
                OrbitalLens
              </h1>
              <p className="text-[10px] sm:text-xs text-white/40 font-medium">Mission Control</p>
            </div>
          </div>
        </div>
